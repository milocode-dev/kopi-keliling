...
<div class="container py-4"> <!-- Header Page --> <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4"> <div> <h2 class="fw-bold mb-1" style="color: #5a3822;"> Daftar Menu ☕ </h2> <p class="text-muted small mb-0"> Kelola semua menu kopi dan minuman yang tersedia di Kopi Gerobakan. </p> </div> <div class="mt-3 mt-md-0"> <a href="{{ route('menu.create') }}" class="btn text-white fw-bold px-4 py-2 rounded-pill shadow-sm" style="background-color: #6b4423;"> + Tambah Menu </a> </div> </div>
<!-- Notifikasi Sukses -->
@if (session('success'))
